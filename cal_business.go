...
func (c *BusinessCalendar) SetWorkdayStart(duration time.Duration) {
	c.workdayStart = duration
}

func (c *BusinessCalendar) SetWorkdayEnd(duration time.Duration) {
	c.workdayEnd = duration
}
